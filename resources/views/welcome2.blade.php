...
<body>
	...
	<ul class="w3-navbar w3-light-grey w3-border">
		...
		<li class="w3-right"><a class="w3-green" href="#" id="auth"
			onclick="document.getElementById('authentication').style.display='block'">Sign In</a></li>
		@endif
	</ul>
	...
	<div id="authentication" class="w3-modal">
		...
		<div class="w3-modal-content w3-card-8 w3-animate-zoom"
			...
			<div class="col-md-12 w3-card-8 w3-teal" onclick="openForm('Login')">
				<h3>Sign In</h3>
			</div>
			...
			<div id="Register" class="w3-container form ">
				<div class="w3-container">
					<div class="w3-section">
						...
						@endif
						<form action="registeruser" method="POST" id="regForm">
							{{ csrf_field() }} 

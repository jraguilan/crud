                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                                ...
                                <div class="col-md-6">                     
                                  <textarea rows="4" cols="50" autofocus class="form-control" id="remarks" name="remarks" value='<?php echo $users2[0]->remarks; ?>'></textarea>
                                </div>
                        </div>  
                                        
                         <div class="col-md-6 col-md-offset-4">
                                <button type="submit" onclick="return confirm('Do you really want to update this record?')" id="button1id" name="button1id" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span> Update</button>
